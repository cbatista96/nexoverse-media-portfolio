...
const i18n = {
  en: {
    ...
    "hero.title.1": "Web, SEO & AI",
    "hero.title.2": "<em>automation</em>",
    "hero.title.3": "from <span class=\"word-3d\">Miami</span>",
    "hero.title.4": "to global growth.",
  ...
  es: {
    ...
    "hero.title.1": "Web, SEO e IA",
    "hero.title.2": "<em>automatización</em>",
    "hero.title.3": "desde <span class=\"word-3d\">Miami</span>",
    "hero.title.4": "para crecer global.",
