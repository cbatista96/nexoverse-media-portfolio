...
const i18n = {
  en: {
    ...
    "meta.desc": "Nexoverse Media — Miami-based digital agency specializing in automation, AI, digital marketing and web development.",
    "og.title": "Nexoverse Media | Digital Agency Miami",
    "og.desc": "We build systems that grow your business. Automation · AI · Digital Marketing · Web Development.",
  ...
  es: {
    "doc.title": "Nexoverse Media",
    "meta.desc": "Nexoverse Media — Agencia digital en Miami especializada en automatización, IA, marketing digital y desarrollo web.",
    "og.title": "Nexoverse Media | Agencia Digital Miami",
    "og.desc": "Transformamos ideas en sistemas que hacen crecer tu negocio. Automatización · IA · Marketing Digital · Desarrollo Web.",
